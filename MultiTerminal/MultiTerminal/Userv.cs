...
namespace MultiTerminal
{
    public class Userv
    {
        ...
        public Userv(MainForm Main,int Port) //서버로 만들때
        {
            main = Main;
            port = Port;
        }

        public Userv(MainForm Main,string IP,int Port) //클라로 만들때
        {
            main = Main;
            port = Port;
            ip = IP;
        ...
        public void ServerStart()
        {
            try
            {
                ...
                IPEndPoint claIP = new IPEndPoint(IPAddress.Any,0);
                EndPoint remot = (EndPoint)(claIP);
